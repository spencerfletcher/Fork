...
<div class="min-h-screen bg-white py-12">
	<div class="container mx-auto max-w-3xl px-4">
		...
		<div class="mb-12 border-b border-amber-100 pb-8">
			<h1 class="font-serif text-4xl font-bold text-gray-900 mb-2">Edit Recipe</h1>
		...
		<form method="POST" use:enhance class="space-y-8">
			...
			<!-- Privacy Section -->
			<section>
				<h2 class="font-serif text-xl font-bold text-gray-900 mb-6 border-t border-amber-100 pt-8">Privacy</h2>
				...
				<div class="flex items-center gap-3">
					<input
						...
						class="w-4 h-4"
					/>
					<label for="public" class="font-medium text-gray-900">Make this recipe public</label>
				</div>
				<p class="text-xs text-gray-500 mt-2">Public recipes can be viewed by anyone on the home page</p>
			</section>
